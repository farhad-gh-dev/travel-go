        ...
        <div className="header">
            ...
            <div className="banner mt-2">
                <div className="small-screen-title">
                    ...
                    <div className="text-capitalize">wanna start your adventure? <button className="link-model no-bg p-1 text-capitalize">learn more</button></div>
                </div>
                <div className="banner-bg-color">
                    <h1 className="title font-italic font-weight-normal m-0">Travel Around the World</h1>
                    <div className="description col-4 col-lg-6 ">An Award Winning Travel Blog, Featuring
                    ...
                    <div className="read-more-btn mt-4 ml-3">
                        <button className="btn-model no-bg text-capitalize">learn more</button>
                    </div>
                </div>
